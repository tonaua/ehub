// Client component for rendering and filtering the products list. By separating
// this logic into its own file marked with the `use client` directive, we
// ensure that stateful hooks like `useState` can be used without violating
// Next.js rules about metadata in client components.
'use client'

import { useState } from 'react'

export default function ProductenClient({ products }) {
